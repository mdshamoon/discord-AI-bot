...
const categoryPrompt =
    "Identify the keywords which indicate a specific issue being faced with a specific feature or service of the Glific platform. Write the keywords in a comma separated string. If no keyword is identified reply with no keywords identified";
